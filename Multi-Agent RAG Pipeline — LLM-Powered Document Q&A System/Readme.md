...
Example PDF reports generated by the pipeline, included in [`sample_reports/`](sample_reports):
 
- [report_healthcare_20260806_164510.pdf](sample_reports/report_healthcare_20260806_164510.pdf) — generated from `sample_data/phc_stockout.csv` (misclassified as healthcare due to medicine-related product names — see note below)
- [report_finance_20260823_114200.pdf](sample_reports/report_finance_20260823_114200.pdf) — generated from `sample_data/finance_transactions.csv`
The finance report is a good validation example: the dataset had synthetic fraud patterns injected (transactions with a fake "Unknown Merchant" label and abnormally high amounts), and the agent correctly flagged this — noting a mean transaction amount of $35,831.39 for "Unknown Merchant" versus $3,409.51 overall, and recommending IQR/z-score outlier detection as a follow-up.
 
**Preview:**
![Sample report preview](screenshots/sample-report-preview.png)
